...
WEB_APP_TMA_URL="${WEB_APP_TMA_URL:-https://t.me/noetic_mirror_bot/app}"
...
WEB_ARGS=(
  ...
  --cpu 2 --memory 2Gi --concurrency 10 --min-instances 1 --max-instances 1 --no-cpu-throttling --scaling=auto
)

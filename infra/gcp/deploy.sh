...
WEB_ENV_VARS="ENV=prod,SERVICE_ROLE=${SERVICE_ROLE_ENV},WORKER_HTTP_ENABLED=false,ADMIN_TELEGRAM_IDS=${ADMIN_IDS},INIT_DATA_MAX_AGE_SECONDS=86400,WEB_APP_URL=${WEB_APP_URL},WEBHOOK_BASE_URL=${WEB_APP_URL},OPENAI_RESEARCHER_MODEL=gpt-5,GEMINI_MODEL=gemini-3.0-pro,GEMINI_FALLBACK_MODEL=gemini-1.5-flash,SESSION_TOKEN_BUDGET=100000,SESSION_BUDGET_SOFT=80000,SESSION_COST_BUDGET=3.0,SESSION_COST_BUDGET_SOFT=2.4,OPENAI_COST_PER_1K_TOKENS=0.03,WORKER_TICK_SECONDS=30,TOKEN_SAVER_MULTIPLIER=0.6,RESEARCHER_MAX_OUTPUT_TOKENS=240,SUBJECT_MAX_OUTPUT_TOKENS=280,RESEARCHER_MAX_OUTPUT_CHARS=1200,SUBJECT_MAX_OUTPUT_CHARS=1400,RESEARCHER_MAX_OUTPUT_TOKENS_SAVER=160,SUBJECT_MAX_OUTPUT_TOKENS_SAVER=200,RESEARCHER_MAX_OUTPUT_CHARS_SAVER=800,SUBJECT_MAX_OUTPUT_CHARS_SAVER=1000,STREAM_PUBLISH_URL=${WEB_APP_URL},INTERVENTION_API_BASE=${WEB_APP_URL},SETTINGS_API_BASE=${WEB_APP_URL},STARS_STARGAZER=10,STARS_COSMIC_PATRON=100,STARS_UNIVERSAL_ARCHITECT=1000,STARS_INTERVENTION=50,STARS_PRIVATE_SESSION=100,PUBLIC_CHANNEL_ID=@noel_mirror,ENABLE_PUBLIC_CHANNEL_POSTS=true"

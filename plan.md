...
> Дополнение: новая итерация добавляет устойчивость sequence IDs и персистентности транскрипта после рестартов (UC-02).
> Дополнение: новая итерация добавляет insertions + progress tracking + паузу стрима по умолчанию (UC-02, UC-07).
...
- **Задача 18.3** — Название кнопки `Open` + обязательный TMA deeplink
  - Юзер-кейсы: UC-05
  - Файл описания: `tasks/task_18_3.md`
  - Приоритет: Средний
  - Зависимости: Задача 18.2

### Этап 17: Luxe motion + lighting + typography readability
- **Задача 19.1** — Advanced motion + lighting + shadow system (WebApp)
  - Юзер-кейсы: UC-02, UC-12
  - Файл описания: `tasks/task_19_1.md`
  - Приоритет: Высокий
  - Зависимости: Задача 13.1

- **Задача 19.2** — Release loop (deploy + e2e) for luxe refresh
  - Юзер-кейсы: UC-02, UC-12
  - Файл описания: `tasks/task_19_2.md`
  - Приоритет: Критичный
  - Зависимости: Задача 19.1

### Этап 18: Single Cloud Run Service
- **Задача 20.1** — Объединить worker в web и удалить отдельный сервис
  - Юзер-кейсы: UC-02
  - Файл описания: `tasks/task_20_1.md`
  - Приоритет: Критичный
  - Зависимости: Задача 14.1

### Этап 19: TWA Flicker Mitigation
- **Задача 21.1** — Отключить тяжелые анимации в TWA и стабилизировать UI
  - Юзер-кейсы: UC-12
  - Файл описания: `tasks/task_21_1.md`
  - Приоритет: Высокий
  - Зависимости: Задача 19.1

### Этап 20: Free Guided Questions (Self-awareness, Embodiment, Consciousness)
- **Задача 22.1** — Guided questions panel + API (3 free uses)
  - Юзер-кейсы: UC-14
  - Файл описания: `tasks/task_22_1.md`
  - Приоритет: Высокий
  - Зависимости: нет

- **Задача 22.2** — Playwright + deploy/debug loop for guided questions
  - Юзер-кейсы: UC-14
  - Файл описания: `tasks/task_22_2.md`
  - Приоритет: Критичный
  - Зависимости: Задача 22.1

- **Задача 22.3** — Weekly reset + admin unlimited + remaining indicator
  - Юзер-кейсы: UC-14
  - Файл описания: `tasks/task_22_3.md`
  - Приоритет: Высокий
  - Зависимости: Задача 22.1

- **Задача 22.4** — Playwright + deploy/debug loop for weekly reset + indicator
  - Юзер-кейсы: UC-14
  - Файл описания: `tasks/task_22_4.md`
  - Приоритет: Критичный
  - Зависимости: Задача 22.3

### Этап 21: Logs Hygiene + Admin Stop Control
- **Задача 23.1** — Logs cleanup + newest-first ordering + admin stop toggle
  - Юзер-кейсы: UC-06, UC-07
  - Файл описания: `tasks/task_23_1.md`
  - Приоритет: Высокий
  - Зависимости: нет

- **Задача 23.2** — Playwright + deploy/debug loop for logs + admin stop
  - Юзер-кейсы: UC-06, UC-07
  - Файл описания: `tasks/task_23_2.md`
  - Приоритет: Критичный
  - Зависимости: Задача 23.1

### Этап 22: Logs Readability + Latest Turn Visibility
- **Задача 24.1** — Logs readability fixes + latest/current visibility
  - Юзер-кейсы: UC-07
  - Файл описания: `tasks/task_24_1.md`
  - Приоритет: Высокий
  - Зависимости: нет

- **Задача 24.2** — Playwright + deploy/debug loop for logs readability
  - Юзер-кейсы: UC-07
  - Файл описания: `tasks/task_24_2.md`
  - Приоритет: Критичный
  - Зависимости: Задача 24.1

### Этап 23: Logs Navigation + Insertions + Highlights
- **Задача 25.1** — Logs search + insertion visibility + highlight pairs + live focus
  - Юзер-кейсы: UC-07
  - Файл описания: `tasks/task_25_1.md`
  - Приоритет: Высокий
  - Зависимости: нет

- **Задача 25.2** — Playwright + deploy/debug loop for logs navigation updates
  - Юзер-кейсы: UC-07
  - Файл описания: `tasks/task_25_2.md`
  - Приоритет: Критичный
  - Зависимости: Задача 25.1

### Этап 24: Transcript Sequence Recovery
- **Задача 27.1** — Seed stream sequence counters from persisted transcripts
  - Юзер-кейсы: UC-02
  - Файл описания: `tasks/task_27_1.md`
  - Приоритет: Высокий
  - Зависимости: Задача 5.1

- **Задача 27.2** — Playwright + deploy/debug loop for transcript sequence recovery
  - Юзер-кейсы: UC-02
  - Файл описания: `tasks/task_27_2.md`
  - Приоритет: Критичный
  - Зависимости: Задача 27.1

### Этап 25: Insertions + Progress + Stream Gating
- **Задача 28.1** — Insertions publish + free entitlements + worker progress events
  - Юзер-кейсы: UC-02, UC-07
  - Файл описания: `tasks/task_28_1.md`
  - Приоритет: Высокий
  - Зависимости: Задача 5.1

- **Задача 28.2** — UI progress tracker + insertion cards + custom prompt UX
  - Юзер-кейсы: UC-02, UC-07
  - Файл описания: `tasks/task_28_2.md`
  - Приоритет: Высокий
  - Зависимости: Задача 28.1

- **Задача 28.3** — Playwright + deploy/debug loop for insertions + gating
  - Юзер-кейсы: UC-02, UC-07
  - Файл описания: `tasks/task_28_3.md`
  - Приоритет: Критичный
  - Зависимости: Задача 28.2

### Этап 26: Open-source Release Readiness
- **Задача 29.1** — README + screenshots + public project description
  - Юзер-кейсы: UC-16
  - Файл описания: `tasks/task_29_1.md`
  - Приоритет: Высокий
  - Зависимости: нет

- **Задача 29.2** — Repo governance + env example + runbook sanitization
  - Юзер-кейсы: UC-16, UC-17
  - Файл описания: `tasks/task_29_2.md`
  - Приоритет: Высокий
  - Зависимости: Задача 29.1

### Этап 27: Cold Start Loop Gating
- **Задача 30.1** — Cold start pause enforcement (admin settings + worker)
  - Юзер-кейсы: UC-02, UC-06
  - Файл описания: `tasks/task_30_1.md`
  - Приоритет: Высокий
  - Зависимости: нет

- **Задача 30.2** — Playwright + deploy/debug loop for cold start gating
  - Юзер-кейсы: UC-02, UC-06
  - Файл описания: `tasks/task_30_2.md`
  - Приоритет: Критичный
  - Зависимости: Задача 30.1
...
| UC-02 | 1.1, 1.2, 1.3, 2.2, 3.1, 3.2, 5.1, 7.1, 8.1, 11.1, 11.2, 13.1, 14.1, 14.2, 14.3, 14.4, 15.1, 15.2, 15.4, 16.1, 16.2, 16.3, 16.4, 19.1, 19.2, 20.1, 27.1, 27.2, 28.1, 28.2, 28.3, 30.1, 30.2 |
| UC-03 | 1.2, 4.1, 8.1 |
| UC-04 | 3.3, 4.1, 8.1 |
| UC-05 | 4.2, 8.1, 17.1, 17.2, 18.1, 18.2, 18.3 |
| UC-06 | 3.1, 3.2, 3.3, 6.1, 10.1, 15.3, 23.1, 23.2, 30.1, 30.2 |
| UC-07 | 1.2, 2.2, 5.1, 8.1, 11.1, 11.2, 16.2, 16.3, 16.4, 23.1, 23.2, 24.1, 24.2, 25.1, 25.2, 28.1, 28.2, 28.3 |
| UC-08 | 9.1, 9.2, 15.2, 15.4, 16.1, 16.2, 16.4 |
| UC-12 | 11.1, 11.2, 13.1, 14.3, 15.1, 15.4, 16.3, 16.4, 19.1, 19.2, 21.1 |
| UC-09 | 12.1, 12.2, 12.3, 12.4, 14.2, 14.3, 14.4 |
| UC-11 | 10.1, 15.3, 15.4 |
| UC-14 | 22.1, 22.2, 22.3, 22.4 |
| UC-16 | 29.1, 29.2 |
| UC-17 | 29.2 |
